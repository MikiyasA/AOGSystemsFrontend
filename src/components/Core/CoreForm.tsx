import { useAddCoreFollowupMutation,  useUpdateCoreFollowupMutation, useUpdateFollowupMutation } from "@/pages/api/apiSlice";
...
const CoreForm = ({data, action}: any) => {
    ...
    const handleFormSubmit = async (e: any) => {
        ...
        if(action === 'add'){
            ...
            addReturn?.id ? notifications.show({
                title: 'Success',
            ...
            updateReturn?.id ? notifications.show({
                title: 'Success',
    ...
    return(
        <>
        {addCFisLoading || updateCFisLoading &&
        <MyLoadingOverlay />}
        ...
        >
            ...
            <DateInput
                ...
                onChange={(e: any) => form.setValues({partReceiveDate: e ? new Date(e.toString()) : null})}
            ...
            <DateInput
                ...
                onChange={(e: any) => form.setValues({returnProcessedDate: e ? new Date(e.toString()) : null})}
